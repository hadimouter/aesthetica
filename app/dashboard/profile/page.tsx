...
import {
  ...
  MessageSquare, ClipboardList, Activity,
  ChevronRight
} from "lucide-react";
        ...
        <Card className="md:col-span-1">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span>
                {profile?.dateOfBirth ? 
                  format(new Date(profile.dateOfBirth), "d MMMM yyyy", { locale: fr }) :
                  "Non renseigné"
                }
              </span>
            </div>
              ...
              <Link href="/documents" className="block">
                <div className="p-4 border rounded-lg hover:shadow-sm transition-shadow">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-2xl font-semibold">{summary?.documents.total || 0}</span>
                  </div>
              ...
              <Link href="/medical-records" className="block">
                <div className="p-4 border rounded-lg hover:shadow-sm transition-shadow">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-2xl font-semibold">{summary?.records.total || 0}</span>
                  </div>
                  <h3 className="font-medium">Dossiers médicaux</h3>
                  <p className="text-sm text-gray-500">Consultations et suivis</p>
                </div>
              </Link>
              ...
              <Link href="/messages" className="block">
                <div className="p-4 border rounded-lg hover:shadow-sm transition-shadow">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-2xl font-semibold">{summary?.messages.total || 0}</span>
                  </div>
              ...
              <TabsContent value="conditions" className="mt-4">
                <ul className="list-disc pl-5 space-y-2">
                  {profile?.medicalHistory?.conditions?.length ? (
                    ...
                    <li className="text-gray-500">Aucune condition médicale renseignée</li>
                  )}
                </ul>
              </TabsContent>
            </Tabs>
        ...
        <Card className="md:col-span-3">
          ...
          <CardContent>
            <div className="space-y-4">
              {summary?.documents.recent && summary.documents.recent.length > 0 ? (
